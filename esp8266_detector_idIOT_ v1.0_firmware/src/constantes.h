...
#define SSID_PORTAL    "Control_idIOT"    // nombre del portal de configuracion
#define PASS_PORTAL    "inopya2023"       // clave apra el portal de configuracion
// **NOTA: las credenciales de la red local deben introducirse mediante el portal de configuracion
