...
enum Constantes 
{
	INTERVALO_ACCESO_CORTO			=  	5000,    // (en ms) tiempo entre accesos al servidor de telegram
	INTERVALO_ACCESO_LARGO			=  20000,
	OFFSET_MIN						=  	 200,
	OFFSET_MAX						=  	 900,
	TIEMPO_PARPADEO_RUNNING			= 	 500,
	TIEMPO_ESPERA_NOTIFICACIONES	=  15000,
};
